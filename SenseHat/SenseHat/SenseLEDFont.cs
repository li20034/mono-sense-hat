namespace SenseHat {
    ...
    public class SenseLEDFont {
        ...
        public const ushort defaultFont = 0;
        
        // Hide internal arrays, external refs use ID so we can use it as a default val for params
        private static class Fonts {
            public static readonly ulong[] defaultFont = {
                5, 8,
                ...
                0x20820820, 0x38421084e, 0x115100000, 0x1f, 0x208000000, 0xe0be2f, 0x4216cc62e, 0xe8422e, 0x42d9c62f, 0xe8fe0e, 
                ...
                0x1f1111f, 0x88441082, 0x108421084, 0x208411088, 0xdb0000
            };
        }
        
        // For internal library use only. Gets font by internal id
        public static ulong[] getFontById(ushort id) {
            switch (id) {
                case 0:
